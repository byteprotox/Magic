...
//
// IMPORTANT: keep ADMIN_EMAIL in sync with firestore.rules and storage.rules.
...
// These values are public by design — security is enforced via Firestore /
// Storage security rules, not by hiding the apiKey.
